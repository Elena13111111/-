...
#сохранение данных в страницу стедентов
...
# зарегестрированные студенты/ обновляет
    def update_wit_initial_students(self, students):  # для добавления новых студентов
        new_students = {}
        initial_students = self.get_config()['users'] # initial_students -> все данные студентов по каждому
